                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="m-b-0">
                                    0.32%
                                    <small data-toggle="tooltip" title="Than last week" class="text-success font-size-11">
                                        1.2%
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="m-b-0">
                                    3,137
                                    <small data-toggle="tooltip" title="Than last week" class="text-danger font-size-11">
                                        0.2%
