            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Admins/Managers List</li>
                    </ol>
                </nav>
            </div>
            <div>
              <div class="btn-group">
                ...
                <form class="form-inline my-2 my-lg-0 " method="post" >
                  <input name="searchKeyword" class="form-control mr-sm-2" type="search" placeholder="Search Admin/Manager" aria-label="Search">
                ...
                <a href="<?php echo base_url(); ?>admin/administrators/add" class="btn btn-gradient-warning btn-uppercase">
                    <i class="fa fa-plus m-r-5"></i>ADD Admin
                </a>
            </div>
        </div>
        <!-- end::page header -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <!-- Active User username -->
                                            <?php echo $auser->username; ?>
                                        </td>
                                        <td>
                                          <!-- Active User email and phone-->
                                            <i class="fa fa-envelope"></i> <?php echo $auser->email; ?><br><br>
                                            <i class="fa fa-phone"></i> <?php echo $auser->phone; ?>
                                        </td>
                                          <td>
                                            <!-- Active User role -->
                                              <i class="fa fa-user"></i> <?php echo $auser->role; ?>
                                          </td>
                                        <td>
                                          <!-- Active User company name-->
                                            <i class="fa fa-user"></i> <?php echo $auser->company; ?>
                                        </td>
                                        <td>
                                            <a class="pull-right dtldata"  href="<?php echo base_url(); ?>admin/administrators/delete_user/<?php echo $auser->user_id; ?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash text-danger fa-lg "></i></a>
                                            <a class="pull-right" href="<?php echo base_url();?>admin/administrators/edit/<?php echo $auser->user_id; ?>"><i class="fa fa-edit text-info fa-lg m-r-10"></i></a>
                                        </td>
                                    </tr>
                                    <?php }
                                    } ?>
